...
namespace oop_project
{
    public partial class RequestRetrieval : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (OleDbConnection myConn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Users\\Leslie\\OneDrive - Cebu Institute of Technology University\\Desktop\\Database2.mdb"))
                {
                    ...
                    AddtoHistory(studName, itemName, StudID, itemDescription, itemType, dateLost, location, imageBytes);
                }
        ...
        public void AddtoHistory(string studName, string itemName, string studentID, string itemDesc, string itemType, string dateLost, string location, byte[] imageBytes)
        {
            try
            {
                ...
                using (OleDbConnection myConn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Users\\Leslie\\OneDrive - Cebu Institute of Technology University\\Desktop\\Database2.mdb"))
                {
                    ...
                    string query = "INSERT INTO HistoryItems (StudentID,StudentName, ItemName, ItemDescription, ItemType, DateLost, LocationLost, Status, Photo) " +
                        "VALUES (@studentID, @studName, @itemName, @description, @type, @date, @loc, @status, @photo)";
                    cmd = new OleDbCommand(query, myConn);
                    cmd.Parameters.AddWithValue("@studentID", studentID);
                    cmd.Parameters.AddWithValue("@studName", studName);
                    cmd.Parameters.AddWithValue("@itemName", itemName);
                    cmd.Parameters.AddWithValue("@description", itemDesc);
                    cmd.Parameters.AddWithValue("@type", itemType);
                    cmd.Parameters.AddWithValue("@date", dateLost);
        ...
        private void dtpLost_ValueChanged(object sender, EventArgs e)
        {
